This repository contains the scripts I used to forecast demand for our products at Dish Network (Examples only, requires connection to private SQL Server)
